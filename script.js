...
contactForm.addEventListener("submit", async (event) => {
  ...
  if (formData.access_key === "PASTE_YOUR_WEB3FORMS_ACCESS_KEY_HERE") {
    formStatus.textContent = "Add your Web3Forms access key in index.html before using the contact form.";
